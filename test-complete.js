// Complete test of the official website classification
const testCompleteClassification = () => {
  ...
  console.log('=== Testing Complete Classification Logic ===\n');
