...
const ProductsClient_1 = require("./modules/products/ProductsClient");
...
app.use(express_1.default.json({ limit: config.REQUEST_SIZE_LIMIT }));
app.use(express_1.default.urlencoded({ extended: true, limit: config.REQUEST_SIZE_LIMIT }));
