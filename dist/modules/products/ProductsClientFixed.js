...
exports.ProductsClientFixed = void 0;
const axios_1 = __importDefault(require("axios"));
class ProductsClientFixed {
    constructor(auth) {
        this.auth = auth;
    ...
    async updateProductFields(productId, updates, updateMask) {
        ...
        try {
            const response = await axios_1.default.post(apiUrl, productInput, {
                headers: {
    ...
    async createProductInput(productData) {
        ...
        const response = await axios_1.default.post(`${this.baseUrl}/accounts/${this.merchantId}/productInputs:insert`, productInput, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json',
            },
...
exports.ProductsClientFixed = ProductsClientFixed;
//# sourceMappingURL=ProductsClientFixed.js.map