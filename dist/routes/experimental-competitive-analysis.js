...
router.post('/analyze', (req, res) => {
    ...
    (async () => {
        try {
            ...
            const scriptPath = path_1.default.join(process.cwd(), 'src/scripts/experimental_competitive_analyzer.py');
            const args = [
                scriptPath,
                '--product', productName,
                '--brand', brand
...
//# sourceMappingURL=experimental-competitive-analysis.js.map