...
router.post('/super-intelligent-analysis', (req, res) => {
    (async () => {
        try {
            const { productName, brand, modelNumber, country = 'Global', brandWebsiteUrl } = req.body;
                    ...
                    if (code === 0 && stdout.trim()) {
                        try {
                            ...
                            if (pythonResult.success && pythonResult.retailers) {
                                ...
                                const retailers = pythonResult.retailers.map((retailer) => ({
...
//# sourceMappingURL=super-intelligent-analysis.js.map